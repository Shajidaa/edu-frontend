        ...
        <section className="mb-16 bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-7/12 p-8 lg:p-12 flex flex-col justify-center">
              ...
              <div>
                <Link href={`/blogs/${featuredPost.id}`} className="flex items-center gap-2 font-semibold text-emerald-600 hover:text-emerald-700 transition-colors group">
                  Read Full Article 
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="mt-auto">
                  <Link href={`/blogs/${post.id}`} className="text-emerald-600 text-sm font-semibold hover:text-emerald-700 transition-colors flex items-center gap-1 group">
                    Read More 
