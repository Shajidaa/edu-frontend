      ...
      <div className="flex-1 p-5 md:p-7 flex flex-col">
        ...
        <div className="mt-auto pt-5 border-t border-slate-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
             <Link href="/booking" className="px-8 py-2.5 border-2 border-green-600 text-green-700 font-bold rounded-lg hover:bg-green-600 hover:text-white transition-all duration-200 shadow-sm active:scale-95">
              Try a free lesson
            </Link>
