    ...
    <section className="py-16 px-4 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-12 text-center">
          ...
          <Link href={'/booking'} className="bg-green-600 hover:bg-green-700 text-white font-black px-10 py-4 rounded-lg text-lg transition-all shadow-lg shadow-green-100 active:scale-95 uppercase tracking-wide">
            Try a free lesson
          </Link>
        </div>
      </div>
