...
export default function WinterHeroSection() {
  return (
    <section className="relative w-full bg-[#430058]  overflow-hidden">
      ...
      <MyContainer className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="text-left space-y-6">
          ...
          <h1 className="text-4xl lg:text-6xl font-extrabold text-white leading-tight">
            Winter Coding Camp <br />
            <span className="text-orange-400">for Kids & Teens 2026</span>
          </h1>

          <div className="space-y-4 max-w-xl">
            <p className="text-slate-300 text-lg leading-relaxed">
              Empower your child with essential coding skills at our Winter Coding Camp. 
